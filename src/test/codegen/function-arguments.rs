...
// CHECK: @struct_return(%S* noalias nocapture sret dereferenceable(32) %{{[0-9]+}})
#[no_mangle]
...
// CHECK: @trait_box({}* noalias nonnull align 1 %{{[0-9]+}}, [3 x [[USIZE]]]* noalias readonly align {{.*}} dereferenceable({{.*}}) %{{[0-9]+}})
#[no_mangle]
